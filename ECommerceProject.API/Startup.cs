...
namespace ECommerceProject.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration.GetConnectionString("ECommerceAppDBConnectionString"));
               // options.UseLazyLoadingProxies();
            });
            //Bu ayar  modelstate otomatik valid kontrolünü devre dýþý býrakýr.
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ECommerceProject.API", Version = "v1" });
            });
